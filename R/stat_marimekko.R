...
Marimekkofy = function(
   data,
   xbucket = 'xbucket',
   ybucket = 'ybucket',
   weight = NULL
) {
   # calculating the transformed xbucket and ybucket for the heatmap
...
StatMarimekkoLabels <- ggproto(
   ...
   compute_group = function(data, scales, overalldata, xlabelyposition) {
...
StatMarimekko <- ggproto(
   ...
   compute_group = function(data, scales, overalldata2, xlabelyposition) {
